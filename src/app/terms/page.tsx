                ...
                <div className="space-y-6 text-gray-600 dark:text-zinc-100">
                    <section>
                        ...
                        <p className="mt-2 text-red-600 dark:text-red-400 font-bold">
                            All data provided on this platform, including ratings, comments, and professor suggestions, is sent and generated by users ONLY. The owner and developers of this platform act solely as a technology provider and do not verify, endorse, or take responsibility for any user-submitted content.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            The Service and its original features and functionality (including the rating system, database structure,
                            and frontend application) are and will remain the exclusive property of the platform and its developers.
                        </p>
                    </section>
