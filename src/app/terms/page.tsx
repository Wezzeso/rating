    ...
    return (
        <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
            <div className="prose prose-blue dark:prose-invert max-w-none">
                <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-zinc-100 mb-8">Terms of Use</h1>

                <div className="space-y-6 text-gray-600 dark:text-zinc-100">
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-100 mb-4">1. Agreement to Terms</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-100 mb-4">2. Community Guidelines and Abuse</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-100 mb-4">3. Suggesting Professors</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-100 mb-4">4. Intellectual Property</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-100 mb-4">5. Limitation of Liability</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-900 dark:text-zinc-100 mb-4">6. Changes to Terms</h2>
                        <p>
